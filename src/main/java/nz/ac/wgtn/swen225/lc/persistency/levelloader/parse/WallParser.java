...
/**
 * Converts a String symbolic representation to a Wall Tile instance.
 * @author Thomas Ru - 300658840
 * @param symbol - the String representation.
 */
record WallParser(String symbol) implements TileParser {
    /**
     * Construct a Wall Tile given a symbolic String representation, if possible.
     * @param surroundings - the LevelMaker context, currently unused.
     * @param tile - the String symbol.
     * @param position - the Position of the tile.
     * @return - the resulting Wall tile.
     */
    @Override
    public Tile parse(LevelMaker surroundings, String tile, Position position) {
        checkTileStartsWithSymbol(tile);
        return Wall.of(Objects.requireNonNull(position, "Position cannot be null."));
    }
}
